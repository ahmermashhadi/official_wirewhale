...
public class SendInfoThatThereIsnotEnoughDataDelegate implements JavaDelegate {

    @NonFinal
    @Value("${api.send-info-not-enough-data}")
    String url;
    ...
    public void execute(DelegateExecution execution) {
        log.info("SendInfoThatThereIsnotEnoughDataDelegate");
